...
// UserData is used to extract data from a post request by client
...
fn query(
    ...
    invitations
        ...
        .map_err(|_db_error| ServiceError::BadRequet("Invalid Invitation".into()))
        .and_then(|mut result| {
            ...
            Err(ServiceError::BadRequet("Invalid Invitation".into()))
        })
}
